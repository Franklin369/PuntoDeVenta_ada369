...
namespace Ada369Csharp.Sunat
{
    public class EmitirComprobante
    {
        ...
        public int EmitirFacturasContado(Lventas parametrosPasar, List<LdetalleVenta> detalleventa)
        {
            Mostrardatosempresa();
            ...
            parametros.Ubigeo = parametrosPasar.Ubigeo;
        ...
        public int EmitirNotaCredito(Lventas parametrosPasar, List<LdetalleVenta> detalleventa)
        {
            Mostrardatosempresa();
            var parametros = new Lventas();
        ...
        public int EmitirNotaDebito(Lventas parametrosPasar, List<LdetalleVenta> detalleventa)
        {
            Mostrardatosempresa();
            var parametros = new Lventas();
            parametros.Cab_Ref_Serie = parametrosPasar.Cab_Ref_Serie;
